export enum Textures {
  ...
  SnowFloorColor = "textures/floor/snow/color.jpg",
  SnowFloorNormal = "textures/floor/snow/normal.jpg",
  SnowFloorDisplacement = "textures/floor/snow/displacement.png",
  SnowFloorRoughness = "textures/floor/snow/roughness.jpg",
  SnowFloorAO = "textures/floor/snow/ao.jpg",
